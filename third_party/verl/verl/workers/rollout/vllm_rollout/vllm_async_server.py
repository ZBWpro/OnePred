...
# Compatibility shim for vllm 0.8.4 which doesn't have run_headless
try:
    from vllm.entrypoints.cli.serve import run_headless
except ImportError:
    # For vllm 0.8.4, run_headless doesn't exist, use run_server instead
    from vllm.entrypoints.openai.api_server import run_server as run_headless
